      ...
      >
        ...
        <div class="z-20 w-full py-6 text-base-100">
          ...
          <div class="py-6 space-x-2">
            <span class="inline-flex items-center justify-center w-10 h-10 text-lg font-bold border-2 border-base-100 rounded-full">
              f
            </span>
            <span class="inline-flex items-center justify-center w-10 h-10 text-lg font-bold border-2 border-base-100 rounded-full">
              G+
          ...
          <form ref={form} class="w-full px-4 mx-auto sm:w-2/3 lg:px-0">
            <div class="pt-4 pb-2">
              <input
                name="id"
                placeholder="id"
            ...
            <div class="text-right text-base-100 hover:text-base-300 hover:underline">
