package com.kjpar0317.batch.job.utils;
...
import com.kjpar0317.batch.model.JobCommon;

//public class MysqlColumnRangePartitioner implements Partitioner {
...
//			
//			JobCommon comm = sql.selectOne("com.innogrid.tabcloudit.batch.tiberodb.common.selectMinMax", tmpMap);
//			
//			if(comm != null) {
